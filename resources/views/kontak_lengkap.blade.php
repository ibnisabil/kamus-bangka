...
<div class="container mx-auto px-6 py-4 pb-20">
    ...
    {{-- Animasi Judul Bagian: Fade in dari kiri --}}
    <h2 class="text-3xl sm:text-4xl font-bold text-white mb-8 border-b-2 border-indigo-500 inline-block pb-2 font-serif" data-aos="fade-right">
        Staf Penghubung
    </h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-16 mt-8">
        ...
        {{-- Kartu Staf 1 --}}
        {{-- Animasi Kartu 1: Muncul dari bawah --}}
        <div class="bg-gray-800 p-6 rounded-xl shadow-xl hover:shadow-2xl hover:shadow-indigo-500/50 hover:-translate-y-1 transition duration-300 border-t-4 border-indigo-500 text-center text-white" data-aos="fade-up">
        ...
        {{-- Kartu Staf 2 --}}
        {{-- Animasi Kartu 2: Muncul dari bawah dengan delay --}}
        <div class="bg-gray-800 p-6 rounded-xl shadow-xl hover:shadow-2xl hover:shadow-indigo-500/50 hover:-translate-y-1 transition duration-300 border-t-4 border-indigo-500 text-center text-white" data-aos="fade-up" data-aos-delay="200">
            <i class="fa-solid fa-user-circle text-6xl text-indigo-400 mb-4"></i>
        ...
        {{-- Kartu Staf 3 --}}
        {{-- Animasi Kartu 3: Muncul dari bawah dengan delay lebih lama --}}
        <div class="bg-gray-800 p-6 rounded-xl shadow-xl hover:shadow-2xl hover:shadow-indigo-500/50 hover:-translate-y-1 transition duration-300 border-t-4 border-indigo-500 text-center text-white" data-aos="fade-up" data-aos-delay="400">
            <i class="fa-solid fa-user-circle text-6xl text-indigo-400 mb-4"></i>
    ...
    {{-- Animasi Judul Bagian 2: Fade in dari kanan --}}
    <h2 class="text-3xl sm:text-4xl font-bold text-white mb-8 pt-12 border-b-2 border-red-500 inline-block pb-2 font-serif" data-aos="fade-right" data-aos-delay="100">
        Kontak Institusi
    </h2>

    {{-- Kontak Institusi Detail --}}
    {{-- Animasi Kontak Institusi: Zoom In --}}
    <div class="bg-gray-800 p-8 rounded-xl shadow-xl border-l-4 border-indigo-500 text-white
        hover:shadow-2xl hover:shadow-indigo-500/50 transition duration-300 hover:-translate-y-1" data-aos="zoom-in" data-aos-delay="300">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div class="flex items-start gap-3 text-lg" data-aos="fade-right" data-aos-delay="500">
            ...
            {{-- Kontak Item: Email --}}
            <div class="flex items-start gap-3 text-lg" data-aos="fade-right" data-aos-delay="700">
            ...
            {{-- Kontak Item: Alamat --}}
            <div class="flex items-start gap-3 text-lg" data-aos="fade-right" data-aos-delay="900">
